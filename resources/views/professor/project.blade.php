                                        ...
                                        <div class="row h-100" style="position: relative; background-color: #c6c6c6;">
                                            <div class="col-md-9">
                                                    ...
                                                    @else
                                                            ...
                                                            @endif
                                                            <button id="changegrade" type="button" class="p-2 btn btn-primary btn-md float-right" data-toggle="modal" data-target="#modalAvaliate-{{$group->idGroup}}" >{{__('gx.change grade')}}</button>
                                                            <style>
                                                                #changegrade{
                                                                    position: absolute;
                                                                    bottom: 0;
